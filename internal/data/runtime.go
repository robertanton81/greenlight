...
var ErrInvalidRuntimeFormat = errors.New("invalid runtime format. Valid format is <runtime> mins")

type Runtime int32

func (r Runtime) MarshalJSON() ([]byte, error) {
	// Convert the runtime to a string, preserving the unit of measurement.
